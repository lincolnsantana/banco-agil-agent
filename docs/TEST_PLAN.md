...
O `BASELINE` fixa os valores da versão atual (`global@1.3.0`, triagem `1.5.0` e
...
| --- | --- | --- | --- | --- | --- |
| `global@1.3.0` + triagem `1.5.0` + especialistas `1.3.0` | `1.0.0` | 1.0 (8/8) | 0 | < 1.000 ms/caso | < 2.700 caracteres |
